...
#endif
/* Tokens.  */
#define STDOUTAPPEND 258
#define STDERROUT 259
#define STDERR 260
#define BACKGROUND 261
#define VAR 262
#define USERNAME 263
#define STRINGLITERAL 264
...
static const yytype_uint8 yyprhs[] =
{
      ...
      22,    24,    27,    29,    32,    35,    38,    40,    42
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      15,     0,    -1,    -1,    15,    16,    -1,    17,    -1,    19,
      -1,    18,    -1,    17,    10,    -1,    17,    18,    -1,    17,
      19,    -1,     4,    -1,     5,     7,    -1,    11,    -1,    12,
       7,    -1,     3,     7,    -1,    13,     7,    -1,     8,    -1,
       9,    -1,     7,    -1
};
...
{
       0,    31,    31,    33,    36,    42,    48,    52,    57,    66,
      87,    92,    97,   101,   105,   109,   115,   157,   160
};
#endif
...
{
  "$end", "error", "$undefined", "STDOUTAPPEND", "STDERROUT", "STDERR",
  "BACKGROUND", "VAR", "USERNAME", "STRINGLITERAL", "'|'", "'&'", "'<'",
  "'>'", "$accept", "commands", "command", "arguments", "ignore",
  "argument", 0
};
#endif
...
{
       2,     0,     1,     0,    10,     0,    18,    16,    17,    12,
       0,     0,     3,     4,     6,     5,    14,    11,    13,    15,
       7,     8,     9
};
...
{
       2,    16,    17,     3,     4,     5,    18,     6,     7,     8,
      19,     9,    10,    11,     3,     4,     5,    21,     6,     7,
       8,    20,     9,    10,    11,    22
};
...
{
       0,    15,     0,     3,     4,     5,     7,     8,     9,    11,
      12,    13,    16,    17,    18,    19,     7,     7,     7,     7,
      10,    18,    19
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 36 "parser/yacc.y"
    {
		chainPush(chainTable, (yyvsp[(1) - (1)].linkedlist));
		YYACCEPT;
	}
    break;

  case 5:
#line 42 "parser/yacc.y"
    {
		// First word
		ll* list = llCreate(1);
		llPush(list, (yyvsp[(1) - (1)].strval), NULL);
		(yyval.linkedlist) = list;
	}
    break;

  case 6:
#line 48 "parser/yacc.y"
    {
		ll* list = llCreate(1);
		(yyval.linkedlist) = list;
	}
  ...
  case 7:
#line 52 "parser/yacc.y"
    {
		chainPush(chainTable, (yyvsp[(1) - (2)].linkedlist));
		chainTable->piped = 1;
		(yyval.linkedlist) = llCreate(1);
	}
    break;

  case 8:
#line 57 "parser/yacc.y"
    {
		...
		(yyval.linkedlist) = (yyvsp[(1) - (2)].linkedlist);
	}
    break;

  case 9:
#line 66 "parser/yacc.y"
    {
		...
		llPush((yyvsp[(1) - (2)].linkedlist), (yyvsp[(2) - (2)].strval), NULL);
		(yyval.linkedlist) = (yyvsp[(1) - (2)].linkedlist);
	}
    break;
...
#line 92 "parser/yacc.y"
    {
		...
		chainTable->fileErrorOut = (yyvsp[(2) - (2)].strval);
		chainTable->fileErrorStdout = 0;
	}
    break;

  case 12:
#line 97 "parser/yacc.y"
    {
...
#line 101 "parser/yacc.y"
    {
		//printf("file in \n");
		chainTable->fileIn = (yyvsp[(2) - (2)].strval);
	}
    break;
...
#line 105 "parser/yacc.y"
    {
		chainTable->fileOut = (yyvsp[(2) - (2)].strval);
		chainTable->fileOutMode = 1;
	}
    break;

  case 15:
#line 109 "parser/yacc.y"
    {
		chainTable->fileOut = (yyvsp[(2) - (2)].strval);
...
#line 115 "parser/yacc.y"
    {
		if (strcmp((yyvsp[(1) - (1)].strval), "") == 0) {
			(yyval.strval) = getenv("HOME");
		}
		else {
			char* str = strdup((yyvsp[(1) - (1)].strval));
